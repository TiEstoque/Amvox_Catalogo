...
// GET  /api/catalog          -> lista todos os itens ativos, já com disponibilidade calculada (público)
// POST /api/catalog          -> adiciona um item novo (Painel Administrativo — exige login)
...
export default async function handler(req, res) {
  try {
    ...
    if (req.method === 'POST') {
      ...
      const { categoria, numero, titulo, descricao, preco, estoque, condicao, fotoUrl } = body;
